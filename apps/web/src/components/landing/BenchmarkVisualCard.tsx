...
const SCANNERS: ScannerData[] = [
  {
    ...
    detectedCount: 12,
    totalCount: 12,
    falsePositives: "6.7% corpus · 8.3% clean room",
    speed: "3.0 ms",
  ...
  },
  {
    ...
    totalCount: 12,
    falsePositives: "0",
    // Not timed in the corpus-v2 run. The previous "18,000 ms" had no measurement behind it.
    speed: "not timed",
    repro: "No",
    deterministic: true,
    statusColor: "#3B82F6",
  ...
  {
    id: "semgrep",
    name: "Semgrep OSS 1.170.1",
    badge: "Static Pattern Scanner",
    detectedCount: 2,
    totalCount: 12,
    falsePositives: "1 (a placeholder in .env.example)",
    speed: "106,000 ms",
    repro: "No",
    deterministic: true,
    statusColor: "#EF4444",
