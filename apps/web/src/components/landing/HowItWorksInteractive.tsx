      ...
      <div className="gp-how-grid">
        ...
        <div className="gp-how-info">
          <div className="gp-how-pill">
            ...
            <span>Phase {step.num} of 04 · {step.badge}</span>
          </div>
              ...
              <div className="gp-view-engine">
                ...
                <div className="gp-engine-bar">
                  <div className="gp-engine-stat">
                    ...
                    <span>Scan latency: <strong>1.1ms</strong></span>
                  </div>
                  <div className="gp-engine-stat">
                    <Cpu size={14} />
                    <span>LLM API tokens: <strong>0</strong></span>
                  </div>
                </div>
              </div>
            )}
                      ...
                      {appliedDiff ? (
                        <>
                          <span className="diff-add">
                            + {"  "}scopes: [<span className="st">&quot;repo:read&quot;</span>], <span className="cm">// Restricted scope</span>
                          </span>
                          {"\n"}
                          <span className="diff-add">
                        ...
                        <>
                          <span className="diff-del">
                            - {"  "}scopes: [<span className="st">&quot;repo:write&quot;</span>, <span className="st">&quot;admin:org&quot;</span>],
                          </span>
                          {"\n"}
                          <span className="diff-del">
