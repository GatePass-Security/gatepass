    ...
    (
      <div
        style={{
          ...
          backgroundImage:
            "radial-gradient(ellipse 62% 52% at 50% 0%, rgba(45,212,191,0.20), transparent 60%)",
          padding: 80,
          color: "#ffffff",
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <span style={{ fontSize: 34, fontWeight: 600, color: "#ffffff", letterSpacing: -1 }}>
            Gatepass
          </span>
        </div>
        ...
        <div style={{ display: "flex", marginTop: 32, maxWidth: 940 }}>
          <span style={{ fontSize: 30, color: "#c0c0c0", lineHeight: 1.4 }}>
            Deterministic security for AI-native and agentic codebases — tool poisoning, confused
            deputies, unauthenticated MCP transports. Same bytes, every run. No model in the loop.
          </span>
        </div>
